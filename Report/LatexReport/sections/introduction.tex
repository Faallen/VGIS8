...
- It is very difficult to define a normal region that correctly represents every possible normal behavior. Also, the separation between normal and abnormal is not always clearly defined.
