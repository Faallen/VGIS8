...
def detect_people(video):
    ...
    # Map video coordinates to court/world coordinates
        ...
        for person in people:
            ...
            if nr_frame > 1:
                ...
                for idx_dist in sorted_indexes:
                    ...
                    # 40 and a point has not already been added to that list,
                    # does so in order of minimum distance to points in lists
                    if distances[idx_dist] < 40 and not predictions_list[idx_dist][0]:
    ...
    helper.save_results_image(predictions_list, tracks_image)
